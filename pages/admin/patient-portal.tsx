...
import PatientDetailForm from "@/components/admin/patient/PatientDetailForm";
  ...
  return (
    <>
      ...
      <Heading
        ...
        description="Details of the ProductName patients portal that supports this app"
      />
      <div className="w-full mt-40 flex justify-center items-center">
        <Button
          onClick={handleOpen}
          className="flex rounded-full m-6 bg-lime font-gilroy-semi-bold capitalize items-center px-4 gap-2"
        >
          <svg
            width="16"
            height="16"
